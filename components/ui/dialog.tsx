...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col text-center sm:text-left space-y-1.5",
      className
    )}
    {...props}
  />
