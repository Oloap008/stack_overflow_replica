...
export async function getSavedQuestionsByUserId(
  ...
  try {
    ...
    const { saved: totalSavedQuestions } = await User.findOne({
      clerkId,
    }).select("saved");
    ...
    return {
      ...
      isNext,
      totalSavedQuestions: totalSavedQuestions.length,
    };
  } catch (error) {
    console.log(error);
    throw error;
...
export async function getUserQuestions(params: GetUserStatsParams) {
  try {
    ...
    return { userQuestions, isNext, totalQuestions };
  } catch (error) {
    console.log(error);
    throw error;
  }
...
export async function getUserAnswers(params: GetUserStatsParams) {
  try {
    ...
    return { userAnswers, isNext, totalAnswers };
  } catch (error) {
    console.log(error);
    throw error;
  }
